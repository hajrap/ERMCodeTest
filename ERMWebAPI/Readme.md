#ERMCalculations Web API
This project shows aggregate data for LP and TOU file 
It consist of one ERMControler.API route is v1/ERMCalculations.
To calculate file data, place file in DataFile folder.
...
Execute unit tests
```
    cd "ERMWebAPI/test/ERMWebAPI.Tests"
    dotnet test
```

Deploy application
```
    cd "ERMWebAPI/src/ERMWebAPI"
